...
function TrackList({ files, onOpen, onPlay, likedIds = new Set(), onToggleLike, playlists = [], onAddToPlaylist, onOpenCreatePlaylist, tableMode = false }) {
  ...
  const renderActions = (f, showPlaylistMenu) => (
        ...
        <div className="panel">
          <div className="panel-hd">
            <span style={{display:'flex', alignItems:'center', gap:8, minWidth:0, flex:1, overflow:'hidden'}}>
              ...
              <span style={{overflow:'hidden', textOverflow:'ellipsis', whiteSpace:'nowrap', color:'#000'}}>/{cat}/</span>
            </span>
          ...
          <div className="panel" style={{margin:'0 12px 12px'}}>
            ...
            {showResults ? (
              ...
              <div className="album-grid" style={{padding:'12px'}}>
...
function IconUserQuestion({ size = 28 }) {
  return (
    <svg width={size} height={size} viewBox="0 0 16 16" fill="currentColor" shapeRendering="crispEdges">
      ...
      {/* Elbow — bends left and down */}
      <rect x="7" y="5" width="2" height="1"/>
      <rect x="7" y="6" width="2" height="2"/>
      {/* Period dot — single, clearly separated */}
...
function Footer() {
  return (
    <div className="footer">
      ...
      <span style={{color:'var(--fg-dim)', fontSize:13, whiteSpace:'nowrap'}}>© METAL.SYS 2026 · Yeremias \m/</span>
    </div>
  );
}
          ...
          <div className="panel section">
            ...
            <div className="panel-body">
              <div style={{overflowX:'auto'}}>
                ...
                {/* Línea base */}
                <div style={{height:2, background:'rgba(255,255,255,0.12)', marginBottom:1}}/>
                    ...
                    return (
                      <div key={artist} style={{flex:`1 1 ${barW}px`,minWidth:barW,display:'flex',justifyContent:'center'}}>
                        <span style={{
                          ...
                          maxHeight:200, overflow:'visible', letterSpacing:'0.05em',
                        }}>
                          {artist}
                        </span>
                      </div>
